...
extern int scanhash_hmq(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done);
...
extern void free_hmq(int thr_id);
...
void hmqhash(void *output, const void *input);
